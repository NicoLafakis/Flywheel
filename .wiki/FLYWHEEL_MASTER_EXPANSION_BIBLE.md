...
```mermaid
graph TD
    A["Metropolis Hub"] --> B["District 1: The Workshop / Maker Yard"]
    A --> C["District 2: Market Street (Dense Props)"]
    A --> D["District 3: Pocket Park (Cozy Greenery)"]
    A --> E["District 4: Office Row (Agency / Tech Lofts)"]
    A --> F["District 5: The Great Flywheel / Clocktower"]
```
