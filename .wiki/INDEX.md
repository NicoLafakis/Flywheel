...
| [plans/](plans/cloud-progress-sync.md) | Proposed, not-started plans: [cloud-progress-sync](plans/cloud-progress-sync.md) (coins, skins, stars and upgrades follow the signed-in player across devices: `player_progress` table, `/api/progress/pull|push`, merge rules, coin fence, phased TDD tasks, ~46 h) |
