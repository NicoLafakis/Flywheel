...
| **4** | `hongkong` | **Hong Kong** (Victoria Harbour) | **Act II** · Asian Megacities | **PLAYABLE** | 32,000 | T3 · NORMAL | Bank of China Tower, Peak Tram, Star Ferry Terminals | `#ff5d8f` | 🚢 |
| **5** | `seoul` | **Seoul** (South Korea) | **Act II** · Asian Megacities | **PLAYABLE** | 32,000 | T4 · SKILLED | N Seoul Tower, Han River Bridges, Gyeongbokgung Gate | `#ff758f` | 🏯 |
...
| **7** | `beijing` | **Beijing** (China) | **Act II** · Asian Megacities | **PLAYABLE** | 38,000 | T4 · SKILLED | Bird's Nest Lattice, CCTV Loop Tower, Imperial Red Walls | `#d90429` | 🐉 |
| **8** | `bangkok` | **Bangkok** (Thailand) | **Act II** · Asian Megacities | **PLAYABLE** | 30,000 | T3 · NORMAL | Wat Arun Spire, Chao Phraya Barges, Tuk-Tuk Markets | `#ffb703` | 🛺 |
| **9** | `mumbai` | **Mumbai** (India) | **Act II** · Asian Megacities | **PLAYABLE** | 34,500 | T4 · SKILLED | Gateway of India, Marine Drive Coastline, Victoria Terminus | `#fb8500` | 🚂 |
| **10** | `dubai` | **Dubai** (UAE) | **Act III** · Desert & Antiquity | **PLAYABLE** | 36,000 | T4 · SKILLED | Burj Khalifa Pinnacle, Palm Monorail, Sail Hotel | `#e0aaff` | 🏜️ |
| **11** | `cairo` | **Cairo** (Egypt) | **Act III** · Desert & Antiquity | **PLAYABLE** | 32,500 | T4 · SKILLED | Giza Limestone Pyramids, Nile Felucca Docks, Citadel Minarets | `#c77dff` | 🐪 |
| **12** | `athens` | **Athens** (Greece) | **Act III** · Desert & Antiquity | **PLAYABLE** | 26,000 | T3 · NORMAL | Acropolis Parthenon, Plaka Stairs, Piraeus Port | `#9d4edd` | 🏛️ |
| **13** | `rome` | **Rome** (Italy) | **Act III** · Desert & Antiquity | **PLAYABLE** | 35,000 | T4 · SKILLED | Colosseum Oval, St. Peter's Dome, Roman Aqueducts | `#7b2cbf` | 🏺 |
| **14** | `paris` | **Paris** (France) | **Act IV** · European Grandeur | **PLAYABLE** | 42,000 | T5 · EXPERT | Eiffel Tower Lattice, Arc de Triomphe, Seine Stone Bridges | `#5a189a` | 🥐 |
| **15** | `london` | **London** (United Kingdom) | **Act IV** · European Grandeur | **PLAYABLE** | 45,000 | T5 · EXPERT | Big Ben Clock Tower, Tower Bridge, The Shard, London Eye | `#3c096c` | 💂 |
| **16** | `amsterdam` | **Amsterdam** (Netherlands) | **Act IV** · European Grandeur | **PLAYABLE** | 28,000 | T3 · NORMAL | Canal Ring Bridges, Gable Townhouses, Windmills | `#240046` | 🚲 |
| **17** | `berlin` | **Berlin** (Germany) | **Act IV** · European Grandeur | **PLAYABLE** | 36,500 | T4 · SKILLED | Brandenburg Gate, Fernsehturm Sphere, Reichstag Dome | `#10002b` | 🐻 |
...
* **Act II: Asian Megacities & High-Density Grids** (6 Metropolises — Hong Kong, Seoul, Tokyo, Beijing, Bangkok, Mumbai — **100% PLAYABLE ACT**)
* **Act III: Desert Horizons & Mediterranean Antiquity** (4 Metropolises — Dubai, Cairo, Athens, Rome — **100% PLAYABLE ACT**)
* **Act IV: European Capitals of Grandeur** (4 Metropolises — Paris, London, Amsterdam, Berlin — **100% PLAYABLE ACT**)
...
**Total:** 29 Metropolises across 7 Acts + Prologue. **24 PLAYABLE** sandboxes currently active (2026-08-21; only Act V's Rio, Buenos Aires, Mexico City, San Francisco and Toronto remain `DEVELOPMENT`, per `js/citycatalog.js`).
