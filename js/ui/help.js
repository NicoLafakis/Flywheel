...
export const WALKTHROUGH_MODULES = Object.freeze([
  ...
  },
  {
    ...
    title: 'Cities, Metropolises & Progression Unlock System',
    icon: '🗺️',
    badge: '8 CITIES',
    summary: 'Explore all 8 handcrafted voxel cities and understand the progression unlock requirements.',
    content: [
      {
        heading: 'The 8 Handcrafted Voxel Metropolises',
        list: [
          '1. THE LAB (Proving Ground · 12,213 blocks): Compact starter grid with ramps, street props, and training structures. Unlocked by default.',
          '2. LOWER MANHATTAN (New York City · 25,875 blocks): Dense Wall Street financial canyon grid with granite plazas and towering monoliths.',
          '3. BROOKLYN (New York City · 39,984 blocks): Sprawling waterfront with suspension bridges, ferry docks, DUMBO lofts, and warehouses.',
          '4. CHICAGO LOOP (Chicago, IL · 44,578 blocks): Colossal skyscraper grid, Willis Tower, river crossings, and runaway elevated CTA train loop.',
          '5. CAMBRIDGE (Massachusetts · 72,943 blocks): Tech hub featuring Kendall Square, brick labs, waterways, and modern campuses.',
          '6. UPPER MANHATTAN (New York City · 73,393 blocks): Central Park perimeter, classic grand museums, and historic brownstone rows.',
          '7. BOSTON SEAPORT (Massachusetts · 82,894 blocks): BCEC convention halls, seaport piers, coastal avenues, and high-density blocks.',
          '8. TOKYO SHINJUKU (Tokyo, Japan · 84,122 blocks): Final Apex mega-metropolis with dazzling neon towers, endless avenues, and Shibuya crossings.',
        ],
      },
      {
        heading: 'City Progression Gate Rule',
        text: 'To unlock each subsequent city in sequence, you must achieve a 100% full clear on the preceding city within the 5-minute (300s) master time limit. Once unlocked, a city remains permanently available for free play and challenges.',
      },
    ],
  },
  {
