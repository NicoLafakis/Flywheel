/* @supabase/realtime-js@2.112.2 — bundled ESM (deps: @supabase/phoenix 0.4.5, tslib 2.8.1 inlined). MIT. Vendored per ADR-0014: same-origin, pinned, never edited; replace wholesale to upgrade. */
