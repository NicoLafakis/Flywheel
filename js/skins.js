...
export const SKINS = [
  ...
  { id: 'baseline-cyan', name: 'Baseline Cyan', price: 0, color: 0x00f0ff, css: '#00f0ff',
    blurb: 'Electric cyan baseline ring. Clean, sharp, high visibility.', build: buildBaseline },
  { id: 'baseline-crimson', name: 'Baseline Crimson', price: 0, color: 0xff0054, css: '#ff0054',
    blurb: 'Neon crimson baseline ring. Aggressive and unmistakable.', build: buildBaseline },
  { id: 'baseline-amber', name: 'Baseline Amber', price: 0, color: 0xffd23f, css: '#ffd23f',
    blurb: 'Electric amber baseline ring. Warm high-contrast glow.', build: buildBaseline },
  { id: 'baseline-emerald', name: 'Baseline Emerald', price: 0, color: 0x06d6a0, css: '#06d6a0',
    blurb: 'Vibrant emerald baseline ring. Smooth neon hue.', build: buildBaseline },
  { id: 'baseline-purple', name: 'Baseline Purple', price: 0, color: 0x9d4edd, css: '#9d4edd',
    blurb: 'Royal violet baseline ring. Deep synthwave aura.', build: buildBaseline },
  { id: 'baseline-orange', name: 'Baseline Orange', price: 0, color: 0xff9f1c, css: '#ff9f1c',
    blurb: 'Bright orange baseline ring. Bold operating cadence.', build: buildBaseline },
  { id: 'baseline-magenta', name: 'Baseline Magenta', price: 0, color: 0xf72585, css: '#f72585',
    blurb: 'Hyper neon magenta baseline ring. Pure arcade radiance.', build: buildBaseline },
